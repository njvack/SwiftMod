...
let package = Package(
    ...
    targets: [
        ...
        .executableTarget(name: "modplay", dependencies: ["SwiftModCore", "SwiftModFormats", "SwiftModEngine", "ModCLI"]),
        .executableTarget(name: "modlive", dependencies: ["SwiftModCore", "SwiftModFormats", "SwiftModEngine"]),
        .executableTarget(name: "modpattern", dependencies: ["SwiftModCore", "SwiftModFormats", "ModCLI"]),
        ...
        .executableTarget(name: "modstate", dependencies: ["SwiftModCore", "SwiftModFormats", "SwiftModEngine", "ModCLI"]),
